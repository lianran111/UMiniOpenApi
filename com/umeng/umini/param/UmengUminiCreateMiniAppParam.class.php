...
class UmengUminiCreateMiniAppParam
{
    ...
    /**
     * @return 类型（小程序：mini,小游戏：mini_game；H5: html5）
     */
    ...
    /**
     * 设置类型（小程序：mini,小游戏：mini_game；H5: html5）
     * @param String $type
     * 参数示例：<pre>mini</pre>
     * 此参数必填     */
    ...
    /**
     * 设置平台(
     * 支付宝小程序：mini_alipay；微信小程序：mini_wechat；天猫精灵：mini_tmall_genie；微信小游戏：mini_game_wechat；字节跳动小程序：mini_bytedance；百度小程序：mini_baidu；QQ小程序：mini_qq
     * ) 【注：除H5外，其他平台必填】
